 ...
 * 
 */
class BranchAndBound : public application::menu::algorithm::Algorithm {
public:
	/**
      * @brief Construct a new BranchAndBound object
      * 
      * @param application - a pointer to the menu application instance
      */
	BranchAndBound(application::menu::Application* application);
